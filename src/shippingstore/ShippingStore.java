...
public class ShippingStore {
    ...
    private String getFormattedUserList(List<User> users) {
        String text ="-----------------------------------------------------------------------"
                + "--------------------------------------------------------------\n";
        text += String.format("| %10s | %9s | %12s | %12s | %20s                    | %n",
    ...
    public String getAllTransactionsText() {
        ...
        String transText ="----------------------------------------------------------------------------------------------"
                + "-------------------------------------------------------------------------------------\n";
        transText += String.format("| %-12s | %12s | %13s | %11s | %45s | %46s | %13s | %n",
                "Transaction", "CustomerID", "EmployeeID", "ptn", "Shipping Date", "Delivery Date", "Price");
        transText += "----------------------------------------------------------------------------------------------"
                + "-------------------------------------------------------------------------------------\n";
        for (Transaction trans : transactions) {
            transText += trans.getFormattedText();
        }
        return transText;
    }
